function [wq, v] = asymmaxcutW( S, X, Wq, V, loss, param, initwq, initv )
...
% V:           The current binary codes for database objects
...
% initv:       The initial value for the new bits of database objects
%
% Output:
% initwq:       The linear separator of the new bit for each query object
% initv:       The new bit for each database object
  ...
  v = initv;                  % One bit in the database
  ...
  while(1)
    ...
    % Chooses a random subset of objects as queries
